...
<div class="mb-4 w-full">
    ...
    <input type="datetime-local" id="start_date" name="start_date" class="mt-1 block w-full" value="{{ old('start_date', $alert->start_date ?? '') }}" >
    @error('start_date')
    <span class="text-red-500">{{ $message }}</span>
    @enderror
</div>
<div class="mb-4 w-full">
    ...
    <input type="datetime-local" id="end_date" name="end_date" class="mt-1 block w-full" value="{{ old('end_date', $alert->end_date ?? '') }}" >
    @error('end_date')
    <span class="text-red-500">{{ $message }}</span>
    @enderror
</div>
<div class="mb-4 w-full">
    ...
    <input type="number" id="radius" name="radius" class="mt-1 block w-full" value="{{ old('radius', $alert->radius ?? '') }}" >
    @error('radius')
    <span class="text-red-500">{{ $message }}</span>
    @enderror
</div>
<div class="mb-4 w-full">
    ...
    <input type="text" id="latitude" name="latitude" class="mt-1 block w-full" value="{{ old('latitude', $alert->latitude ?? '') }}" >
    @error('latitude')
    <span class="text-red-500">{{ $message }}</span>
    @enderror
</div>
<div class="mb-4 w-full">
    ...
    <input type="text" id="longitude" name="longitude" class="mt-1 block w-full" value="{{ old('longitude', $alert->longitude ?? '') }}" >
    @error('longitude')
    <span class="text-red-500">{{ $message }}</span>
    @enderror
</div>
<div class="mb-4 w-full">
    ...
    <textarea id="description" name="description" class="mt-1 block w-full" >{{ old('description', $alert->description ?? '') }}</textarea>
    @error('description')
    <span class="text-red-500">{{ $message }}</span>
    @enderror
</div>
<div class="mb-4 w-full">
    ...
    <select id="danger_level" name="danger_level" class="mt-1 block w-full" >
