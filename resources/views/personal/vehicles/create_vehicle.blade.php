    ...
    <div class="py-12 relative">
        ...
        <div class="max-w-[80%] mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Crear nuevo vehículo</h1>
                @include('personal.vehicles.form_vehicle', ['vehicle' => null, 'method' => 'post', 'route' => 'vehicles.store'])
            </div>
        </div>
    </div>
